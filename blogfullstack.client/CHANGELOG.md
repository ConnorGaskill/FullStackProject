...
- Create Angular project with ng: `ng new blogfullstack.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`blogfullstack.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `blogfullstack.client.esproj`).
